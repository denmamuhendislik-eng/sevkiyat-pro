    84: 178, 109: 150, 123: 161, 152: 156,
  };
  const KG_FIXES = {
    150: 92,   // 151-0521 PLAKA LAZER KESİM ST37 — 15mm ST37 doğru kg
  };

  const runDuplicateMigration = async () => {
    if (!isAdmin || !db) { alert("Yetki yok veya bağlantı hazır değil."); return; }

    // Preview hesapla
    const preview = {
      productsRemoved: [], kgFixes: [], yearChanges: [],
      packingChanges: [], combRuleChanges: [],
    };
    Object.entries(FANTOM_MERGE_MAP).forEach(([f, a]) => {
      const fantom = products.find(p => p.id === Number(f));
      const active = products.find(p => p.id === Number(a));
      if (fantom && active) preview.productsRemoved.push({fantom: f, fantomName: fantom.nameTR, active: a, activeName: active.nameTR});
    });
    Object.entries(KG_FIXES).forEach(([pid, newKg]) => {
      const p = products.find(pr => pr.id === Number(pid));
      if (p && p.kg !== newKg) preview.kgFixes.push({pid, name: p.nameTR, oldKg: p.kg, newKg});
    });
    Object.entries(yearsData || {}).forEach(([year, ydata]) => {
      if (!ydata) return;
      let totalsChanges = 0, qtyChanges = 0, plannedChanges = 0;
      const totals = ydata.totals || {};
      const quantities = ydata.quantities || {};
      const planned = ydata.planned || {};
      Object.entries(FANTOM_MERGE_MAP).forEach(([f]) => {
        if (totals[f]) totalsChanges++;
        if (planned[f]) plannedChanges++;
        Object.values(quantities).forEach(q => { if (q && q[f]) qtyChanges++; });
      });
      if (totalsChanges + qtyChanges + plannedChanges > 0) preview.yearChanges.push({year, totalsChanges, qtyChanges, plannedChanges});
    });
    Object.entries(packingStandards || {}).forEach(([pid]) => {
      if (FANTOM_MERGE_MAP[pid]) preview.packingChanges.push({fantom: pid, active: FANTOM_MERGE_MAP[pid]});
    });
    (combRules || []).forEach((r, ri) => {
      if (FANTOM_MERGE_MAP[r.parent]) preview.combRuleChanges.push({idx: ri, type: 'parent', from: r.parent, to: FANTOM_MERGE_MAP[r.parent]});
      (r.children || []).forEach(c => { if (FANTOM_MERGE_MAP[c]) preview.combRuleChanges.push({idx: ri, type: 'child', from: c, to: FANTOM_MERGE_MAP[c]}); });
    });

    const previewText =
      `📋 DUPLİKA TEMİZLİK ÖN İZLEMESİ\n═══════════════════════════════════════\n\n` +
      `🔧 KG düzeltmeleri (${preview.kgFixes.length}):\n` +
      (preview.kgFixes.length > 0 ? preview.kgFixes.map(f => `  • #${f.pid} ${f.name}: ${f.oldKg} → ${f.newKg} kg`).join("\n") + "\n\n" : "  (yok)\n\n") +
      `🔀 Birleştirilecek ürünler (${preview.productsRemoved.length}):\n` +
      preview.productsRemoved.map(p => `  • #${p.fantom} → #${p.active} (${p.activeName.substring(0, 40)})`).join("\n") + "\n\n" +
      `📅 Yearly veri taşıma (${preview.yearChanges.length} yıl):\n` +
      (preview.yearChanges.length > 0 ? preview.yearChanges.map(y => `  • ${y.year}: ${y.totalsChanges} toplam, ${y.qtyChanges} konteyner, ${y.plannedChanges} plan`).join("\n") + "\n\n" : "  (yok)\n\n") +
      `📦 Paketleme std (${preview.packingChanges.length}):\n` +
      (preview.packingChanges.length > 0 ? preview.packingChanges.map(p => `  • #${p.fantom} → #${p.active}`).join("\n") + "\n\n" : "  (yok)\n\n") +
      `🔗 Kombine kuralları (${preview.combRuleChanges.length}):\n` +
      (preview.combRuleChanges.length > 0 ? preview.combRuleChanges.map(c => `  • Kural ${c.idx} ${c.type}: ${c.from} → ${c.to}`).join("\n") + "\n\n" : "  (yok)\n\n") +
      `═══════════════════════════════════════\n\n⚠ Bu işlem GERİ ALINAMAZ. Yedek aldığınızdan emin olun.\n\nDevam edilsin mi?`;

    if (!confirm(previewText)) return;
    if (!confirm(`Son onay: ${preview.productsRemoved.length} ürün silinecek, ${preview.yearChanges.length} yıl verisi değişecek.\n\nKesin devam?`)) return;

    try {
      // Migration uygula
      let newProducts = [...products];
      Object.entries(KG_FIXES).forEach(([pid, newKg]) => {
        newProducts = newProducts.map(p => p.id === Number(pid) ? {...p, kg: newKg} : p);
      });
      const fantomIds = new Set(Object.keys(FANTOM_MERGE_MAP).map(Number));
      newProducts = newProducts.filter(p => !fantomIds.has(p.id));

      const newYearsData = JSON.parse(JSON.stringify(yearsData || {}));
      Object.values(newYearsData).forEach(ydata => {
        if (!ydata) return;
        if (ydata.totals) {
          Object.entries(FANTOM_MERGE_MAP).forEach(([f, a]) => {
            const fStr = String(f), aStr = String(a);
            if (ydata.totals[fStr]) {
              ydata.totals[aStr] = (ydata.totals[aStr] || 0) + ydata.totals[fStr];
              delete ydata.totals[fStr];
            }
          });
        }
        if (ydata.planned) {
          Object.entries(FANTOM_MERGE_MAP).forEach(([f, a]) => {
            const fStr = String(f), aStr = String(a);
            if (ydata.planned[fStr]) {
              ydata.planned[aStr] = (ydata.planned[aStr] || 0) + ydata.planned[fStr];
              delete ydata.planned[fStr];
            }
          });
        }
        if (ydata.quantities) {
          Object.values(ydata.quantities).forEach(q => {
            if (!q) return;
            Object.entries(FANTOM_MERGE_MAP).forEach(([f, a]) => {
              const fStr = String(f), aStr = String(a);
              if (q[fStr]) {
                q[aStr] = (q[aStr] || 0) + q[fStr];
                delete q[fStr];
              }
            });
          });
      ...
      const newPackingStandards = {...(packingStandards || {})};
      Object.entries(FANTOM_MERGE_MAP).forEach(([f, a]) => {
        if (newPackingStandards[f]) {
          if (!newPackingStandards[a]) newPackingStandards[a] = newPackingStandards[f];
          delete newPackingStandards[f];
        }
      });

      const newCombRules = (combRules || []).map(r => {
        const newR = {...r};
        if (FANTOM_MERGE_MAP[newR.parent]) newR.parent = FANTOM_MERGE_MAP[newR.parent];
        if (newR.children) {
          newR.children = newR.children.map(c => FANTOM_MERGE_MAP[c] || c);
          newR.children = [...new Set(newR.children)];
        }
        return newR;
      });
      ...
      setPackingStandards(newPackingStandards);
      setCombRules(newCombRules);

      alert(
        `✅ MIGRATION TAMAMLANDI\n\n` +
        `• ${preview.productsRemoved.length} fantom ürün silindi\n` +
        `• ${preview.kgFixes.length} kg düzeltildi\n` +
        `• ${preview.yearChanges.length} yıl verisi taşındı\n` +
        `• ${preview.packingChanges.length} paketleme std taşındı\n` +
        `• ${preview.combRuleChanges.length} kombine kuralı güncellendi\n\n` +
        `Değişiklikler 1-2 saniye içinde Firestore'a kaydedilecek.\n\nLütfen sayfayı yenileyip kontrol edin.`
      );
    } catch (e) {
      console.error("Migration hatası:", e);
      alert("❌ Migration başarısız: " + e.message + "\n\nVeri değişmedi (atomic). Yedekten restore gerekirse hazır.");
    }
  };
      ...
      <div style={{width:sidebar?210:52,background:"var(--color-background-primary)",borderRight:"1px solid var(--color-border-tertiary)",display:"flex",flexDirection:"column",transition:"width 0.2s",flexShrink:0,overflow:"hidden"}}>
        ...
        {sidebar&&<div style={{padding:"10px 14px",borderTop:"1px solid var(--color-border-tertiary)",fontSize:10,color:"var(--color-text-tertiary)"}}>
          ...
          <div style={{display:"flex",gap:4}}>
            ...
            {isAdmin&&<button onClick={runDuplicateMigration} style={{...bS,padding:"2px 6px",fontSize:9,color:"#BA7517",borderColor:"#BA7517"}} title="VIO duplika temizlik (8 fantom pid'i aktif pid'lere merge eder, geri alınamaz!)">🔧 Temizlik</button>}
...

        {
          ...
          sorted.forEach(({ bp, bi, depth }) => {
            ...
            if (parent && (parent.parentIdx === null || parent.parentIdx === undefined)) {
              ...
              // v15 fix: supplyType inclusion ("MAKE"||"MAKE+FASON"||"FASON") legacy
              // BOM kayıtlarında bazı MAKE parçalar "PRODUCT" olarak duruyor (v13 migrasyonu
              // bomModels'a tam yansımamış). Bu branch tetiklenmediğinde child, parent'ın
              // cascade kapsamasını öğrenemiyor → 151-0526 gibi RAW'lar için yanlış talep.
              // Çözüm: line 7354 initial propagation ile aynı stil — parent BUY/RAW değilse
              // "üretici" say. Böylece PRODUCT, MAKE, MAKE+FASON, FASON hepsi kapsanır.
              const parentBi = bp.parentIdx;
              const parentNeeded = Math.ceil(bomQtys[parentBi] || 0);
              const parentCovCasc = partCoveredCascade[parentBi] || 0;
              if (parentCovCasc >= parentNeeded) { bomQtys[bi] = 0; return; }
                        ...
                        <div style={{ padding: "6px 12px 12px", marginBottom: 6, background: "#F0FDF4", borderRadius: 8, border: "1px solid #BBF7D0" }}>
                          ...
                          {(() => {
                            ...
                            const poTakipParts = allParts.filter(p => {
                              ...
                              // PO var ve hâlâ eksik kalan talep varsa PO takibe al.
                              // Önceki: rem < totalShort (kısmi karşılama) — PO tam karşılarsa kör nokta oluyordu.
                  ...
                  (r.sources || []).forEach(s => {
                    ...
                    if (!pMap[pid]) {
                      ...
                      pMap[pid] = { pid, name: pr?.nameTR || `PID ${pid}`,
                        ...
                        productWipRaw: d.productWipRaw || 0, productPlsRaw: d.productPlsRaw || 0,
