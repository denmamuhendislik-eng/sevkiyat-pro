...
export default function App() {
  ...
  const LOGO_ISO = "data:image/png;base64,";
  ...
  const generatePalletLabelPDF = () => {
    ...
    const pages = pallets.map(pl => {
      ...
      pl.items.forEach((it,i) => {
        itemRows += `<tr>
          <td style="padding:2px 6px;text-align:center;border:1px solid #000;font-size:9px">${i+1}</td>
          <td style="padding:2px 6px;border:1px solid #000;font-size:9px">${it.nameEN}</td>
          <td style="padding:2px 6px;text-align:center;border:1px solid #000;font-size:9px">${it.qty}</td>
          <td style="padding:2px 6px;text-align:right;border:1px solid #000;font-size:9px">${fk2(it.kg*it.qty)}</td>
          <td style="padding:2px 6px;text-align:right;border:1px solid #000;font-size:9px">${fk2(it.kg*it.qty + (i===0 ? pl.dara : 0))}</td>
        </tr>`;
      });
      ...
      return `<div class="label-page" style="width:200mm;height:100mm;padding:4mm 5mm;font-family:Arial,sans-serif;color:#000;box-sizing:border-box;page-break-after:always;overflow:hidden;${isHeavy?'border:3px solid #C00;':''}">
        <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:3mm">
          <div>
            ...
            <div style="font-size:7px;margin-top:2mm;line-height:1.5">
              <b>${DENMA_INFO.name}</b><br>
              ${DENMA_INFO.address}<br>
        ...
        <div style="border:2px solid #000;padding:1.5mm 4mm;margin-bottom:2mm;text-align:center">
          <div style="font-size:9px">TO: <b>${CUSTOMER.name}</b></div>
          <div style="font-size:14px;font-weight:800;margin-top:0.5mm">${CUSTOMER.city} / ${CUSTOMER.country}</div>
        </div>
        <table style="width:100%;border-collapse:collapse">
          <thead><tr style="background:#eee">
            <th style="padding:2px 6px;border:1px solid #000;font-size:8px;width:24px">Nr.</th>
            <th style="padding:2px 6px;border:1px solid #000;font-size:8px;text-align:left">Description</th>
            <th style="padding:2px 6px;border:1px solid #000;font-size:8px;width:36px">Qnt.</th>
            <th style="padding:2px 6px;border:1px solid #000;font-size:8px;text-align:right;width:60px">Net Kg</th>
