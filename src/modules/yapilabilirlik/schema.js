...
// Her sorunun `dept` alanı hangi grubun cevaplayacağını gösterir.
// 2026-07-21: eski 5-dept sistem 3'e indirildi (sales / technical / management).
export const EVALUATION_QUESTIONS = [
  { key: "canMeetDemands",       label: "Şirketin imkanları müşteri taleplerini karşılıyor mu?",              dept: "technical" },
  { key: "needsInvestment",      label: "Ek yatırım gerekiyor mu?",                                           dept: "technical" },
  { key: "hasCapacity",          label: "Yeterli kapasite ve imkanlar mevcut mu?",                            dept: "technical" },
  { key: "companyBenefit",       label: "Şirkete getireceği ilerleme ve katkı payı var mı?",                  dept: "management" },
  { key: "materialSupply",       label: "Malzeme ve yan ürünleri temin edebilme imkanı",                      dept: "technical" },
  { key: "shipmentTerms",        label: "Sevkiyat ve teslimat şartları belirlenmiş mi?",                      dept: "sales" },
  { key: "specialCharacteristics", label: "Özel karakteristikler belirlenmiş mi?",                            dept: "technical" },
  ...
  { key: "technicalDocs",        label: "Gerekli teknik dokümanlar ve standartlar temin edilebilmiş mi?",     dept: "technical" },
...
// Departmanlar — accordion başlıkları (3 grup)
export const EVALUATION_DEPARTMENTS = [
  { key: "sales",       label: "Satış ve Proje",             icon: "💼", color: "#1e40af", bg: "#eff6ff" },
  { key: "technical",   label: "Teknik Birim",                icon: "⚙️", color: "#0f766e", bg: "#f0fdfa" },
